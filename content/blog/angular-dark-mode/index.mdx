...
slug: angular-dark-mode
description: |
  Integrate dark mode into your Angular application with ease!
categories: [angular]
keywords: [angular, dark-mode, tutorial]
date: 2020-10-06
banner: ./images/banner.webp
bannerCredit: Mikael Kristenson
bannerCreditUrl: https://unsplash.com/@mikael_k
---
...
> Note: Final code and demo available in [this stackblitz](https://stackblitz.com/edit/angular-dark-mode-blog-example?file=src%2Fapp%2Fapp.component.ts).
...
![angular-dark-mode example](./images/example.gif)
